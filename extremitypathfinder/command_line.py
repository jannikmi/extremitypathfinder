...
JSON_HELP_MSG = ('path to the JSON file to be read. '
...
def main():
    ...
    parser.add_argument("-s", "--start", nargs=2, type=float, required=True,
                        help="the start coordinates given as two float values, e.g. <2.5 3.2>")
    parser.add_argument("-g", "--goal", nargs=2, type=float, required=True,
